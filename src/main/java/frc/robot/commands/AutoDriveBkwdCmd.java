...
public class AutoDriveBkwdCmd extends CommandBase {
  ...
  @Override
  public void execute() {
    driveSubsystem.setMotors(Constants.AutoConstants.kAutoDriveBkwdSpeed, Constants.AutoConstants.kAutoDriveBkwdSpeed);
  }
